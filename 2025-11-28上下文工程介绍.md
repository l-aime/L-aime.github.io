...
AI发展愈演愈烈，各大科技巨头争相抢占AI高地，大模型榜单日新月异：ChatGPT、DeekSeek、千问、Gemini...层出不穷。另一边围绕大模型的应用开发也没有闲着 Manus、Cursor、Claude不断刺激着人们的眼球，这些新产品的诞生无一不向人们宣告着：AI时代已经到来。新的时代，自然会有新的技术思潮和开发理念：Agent、MCP、A2A、SDD等新理念、开发范式，一遍遍地刺激着我们紧张的神经：没有人想在这次新浪潮里被落下。技术人的兴奋与迷茫，在这场没有尽头的追逐中
